...
Original file is located at
    https://colab.research.google.com/drive/1qVXgVr0IXELDzqqrLfp353mXSzpvgpXE
"""
...
if __name__ == '__main__':
	...
	dataroot = r'dir to your dataset'
	...
	for epoch in range(num_epochs):
	    ...
	    if epoch % num_epochs == 0:
	        torch.save({
	            ...
	            }, rf'--dir you want ot save the train model/model_epoch_{epoch}.pth')
	...
	torch.save({
	            ...
	            'optimizerG' : optimizerG.state_dict(),
	            'optimizerD' : optimizerD.state_dict(),
	            }, r'--dir you want ot save the train model/model_final.pth')
